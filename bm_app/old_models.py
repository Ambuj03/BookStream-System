...
class Distributor(models.Model):
    ...
    distributor_email = models.CharField(max_length=100,unique=True)
    distributor_password = models.CharField(max_length=100)
    distributor_age = models.IntegerField(blank=True, null=True)
    created_at = models.DateTimeField(blank=True, null=True)
    admin = models.ForeignKey('Admin', models.DO_NOTHING,default=None) # changed admin to admin_id
